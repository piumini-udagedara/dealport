...
exports.ValidationGuard = void 0;
const common_1 = require("@nestjs/common");
const class_validator_1 = require("class-validator");
const class_transformer_1 = require("class-transformer");
let ValidationGuard = class ValidationGuard {
    dtoClass;
    ...
    canActivate(context) {
        ...
        const dto = (0, class_transformer_1.plainToInstance)(this.dtoClass, request.body);
...
exports.ValidationGuard = ValidationGuard = __decorate([
