...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Products returned successfully' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Top products returned successfully' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get one product by id' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Product returned successfully' }),
